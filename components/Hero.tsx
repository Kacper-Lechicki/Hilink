  ...
  return (
    <section className="max-container padding-container flex flex-col gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row">
      ...
      <div className="relative z-20 flex flex-1 flex-col xl:w-1/2">
        <Image
          className="absolute left-[-5px] top-[-35px] w-10 lg:w-[50px] lg:h-[50px]"
          src="/camp.svg"
          alt="camp"
          width={50}
          height={50}
        ...
        <h1 className="text-[52px] font-bold leading-[100%] lg:text-[88px]">
        ...
        <div className="my-11 flex flex-wrap gap-5">
          ...
          <p className="text-[16px] font-[700] lg:bold-20 text-blue-70">
            198k
            <span className="text-[16px] font-[400] lg:regular-20 ml-2">
              Excellent Reviews
            </span>
          </p>
        </div>
